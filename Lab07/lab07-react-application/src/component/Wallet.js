...
class Wallet extends React.Component {
    ...
    // TODO-9: charge money
    handleChargeMoney = () => {
        const val = parseInt(this.state.chargeMoney);
        if (!isNaN(val) && val > 0) {
            this.props.handleAdjustMoney(val)
                .then(msg => alert(msg))
                .catch(err => alert(err));
                    ...
                    <Grid container justifyContent="space-around">
                        ...
                        <Grid item container xs={5}>
                            ...
                            <TextField
                                ...
                                onChange={(e) => this.setState({ chargeMoney: e.target.value })}
                            />
                        </Grid>
                        <Grid item container xs={2}>
                            ...
                            <IconButton 
                                ...
                                onClick={this.handleChargeMoney} // 修正：將 onClick 放在 IconButton 上
                            >
